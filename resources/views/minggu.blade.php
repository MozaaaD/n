      ...
      <div  style="background-color:rgb(255, 255, 255)" class=" text-center ">
        <div class="container text-center">
          <div class="row">
            <div class="col">
              Minggu 1
              <h5 class="bg-warning rounded" style="color:rgb(255, 255, 255)">01.09 ~ 07.09</h5>
            </div>
            <div class="col mt-3">
      ...
      <div  style="background-color:rgb(255, 255, 255)" class=" text-center ">
        <div class="container text-center">
          <div class="row">
            <div class="col">
              Minggu 2
              <h5 class="bg-secondary rounded" style="color:rgb(255, 255, 255)">08.09 ~ 14.08</h5>
            </div>
            <div class="col">
      ...
      <div  style="background-color:rgb(255, 255, 255)" class=" text-center ">
        <div class="container text-center">
          <div class="row">
            <div class="col">
              Minggu 3
              <h5 class="bg-secondary rounded" style="color:rgb(255, 255, 255)">14.09 ~ 21.09</h5>
            </div>
            <div class="col">
              <h5 style="color:green" class="mt-3" >Rp.0</h5>
            </div>
      ...
      <div  style="background-color:rgb(255, 255, 255)" class=" text-center ">
        <div class="container text-center">
          <div class="row">
            <div class="col">
              Minggu 4
              <h5 class="bg-secondary rounded" style="color:rgb(255, 255, 255)">21.09 ~ 28.09</h5>
            </div>
            <div class="col">
              <h5 style="color:green" class="mt-3" >Rp.0</h5>
            </div>
      ...
      <div  style="background-color:rgb(255, 255, 255)" class=" text-center ">
        <div class="container text-center">
          <div class="row">
            <div class="col">
              Minggu 5
              <h5 class="bg-secondary rounded" style="color:rgb(255, 255, 255)">28.09 ~ 30.09</h5>
            </div>
            <div class="col">
              <h5 style="color:green" class="mt-3" >Rp.0</h5>
            </div>
